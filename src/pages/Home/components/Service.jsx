...
const Service = () => {
    return (
        <section className=' bg-custom-white-fade w-full  py-20 px-20 flex flex-col'>
            <h3 className="text-text-custom-black text-[56px]/[67.2px] font-medium text-center">
            Our Service Incubation Model
            </h3>
            <p className='font-normal text-[17px]/[26.4px]  px-12 w-3/4 text-wrap ml-auto mr-auto text-center mt-6'>
