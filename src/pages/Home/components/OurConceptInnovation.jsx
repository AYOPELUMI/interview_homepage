const OurConceptInnovatiion = () => {
    return (
        <section className=' bg-custom-white-fade w-full  py-12 px-20 flex flex-col'>
            ...
            <p className='font-normal text-[16px]/[22.4px] text-wrap ml-auto mr-auto text-center w-3/5 mt-12'>
            ...
            <div className='flex mt-16 gap-10'>
                ...
                <div className='bg-white flex-1 flex flex-col rounded-xl py-5 px-4 gap-9 items-center'>
                    <p className='font-medium text-text-custom-black text-[22px]/[26.4px]'>Service Incubator</p>
                ...
                <div className='bg-white flex-1 flex flex-col rounded-xl py-5 px-4 gap-9 items-center'>
                <p className='font-medium text-text-custom-black text-[22px]/[26.4px]'>Virtualting</p>
                <p className='font-normal text-text-custom-black text-[16px]/[22px] text-wrap text-left'>
                ...
                <div className='bg-white flex-1 flex flex-col rounded-xl py-5 px-4 rounded-xl py-5 px-4 gap-9 items-center justify-between items-center'>
                <p className='font-medium text-text-custom-black text-[22px]/[26.4px]'>Diiming</p>
                <p className='font-normal text-text-custom-black text-[16px]/[22px] text-wrap text-left'>
...
export default OurConceptInnovatiion
