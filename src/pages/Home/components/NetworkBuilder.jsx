...
const NetworkBuilder = () => {
    return (
        <section className='  flex flex-col py-9 gap-6 items-center justify-center'>
            <h3 className="text-[66px]/[82.8px] font-medium text-wrap text-center text-text-custom-black w-3/4 text-wrap">Network of builder helping startup scale</h3>
            <div className='flex gap-5 px-14 mt-5'>
                <aside className='flex-1 flex flex-col gap-4 p-6 bg-white '>
                ...
                <aside className=' flex-1 flex flex-col gap-4 p-6 bg-white'>
                    <h4 className=' flex-auto text-black text-[28px]/[28.8px] text-left font-medium text-wrap'>
                    ...
                    <a className='text-black  font-bold text-lg flex gap-1 border-b w-fit items-center'>
                        Learn More
                        <FaArrowRightLong />
                    </a>
                </aside>
